...
macro_rules! shape_dispatch {
    ($sector_size: ident, $fun: ident, $uuid: ident) => {{
        match $sector_size as u64 {
            ...
            filecoin_proofs::SECTOR_SIZE_16_KIB => $fun::<filecoin_proofs::SectorShape16KiB>(&$uuid),
            filecoin_proofs::SECTOR_SIZE_32_KIB => $fun::<filecoin_proofs::SectorShape32KiB>(&$uuid),
            filecoin_proofs::SECTOR_SIZE_8_MIB => $fun::<filecoin_proofs::SectorShape8MiB>(&$uuid),
            filecoin_proofs::SECTOR_SIZE_16_MIB => $fun::<filecoin_proofs::SectorShape16MiB>(&$uuid),
            filecoin_proofs::SECTOR_SIZE_512_MIB => $fun::<filecoin_proofs::SectorShape512MiB>(&$uuid),
            filecoin_proofs::SECTOR_SIZE_1_GIB => $fun::<filecoin_proofs::SectorShape1GiB>(&$uuid),
            filecoin_proofs::SECTOR_SIZE_32_GIB => $fun::<filecoin_proofs::SectorShape32GiB>(&$uuid),
            filecoin_proofs::SECTOR_SIZE_64_GIB => $fun::<filecoin_proofs::SectorShape64GiB>(&$uuid),
